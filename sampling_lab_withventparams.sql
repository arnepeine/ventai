...
--NOTE: Took 5 minutes to query.
DROP MATERIALIZED VIEW IF EXISTS sampled_lab_withventparams;
CREATE MATERIALIZED VIEW sampled_lab_withventparams as
...
FROM overalltable_lab_withventparams
...
FROM grid g
LEFT JOIN overalltable_lab_withventparams ot ON ot.charttime >= g.start_time
